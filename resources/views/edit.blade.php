...
<nav class="navbar navbar-dark bg-dark">
  ...
  <div class="container-fluid">
    ...
    <a class="navbar-brand btn btn-primary" href="{{  route('index'  )}}">Home </a>
...
<form action="{{ route('update', base64_encode($Data->id)) }}" method="post">
    @csrf
    <h1 class='text-center m-3'>Edit User</h1>
  ...
  <div class="mb-3">
   ...
   <div class="mb-3">
    ...
    <input type="text" name="number" value="{{ $Data->phone_number}} " class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
      @error('number')
    <div id="emailHelp" class="form-text text-danger">{{$message}} </div>
    @enderror
  </div>
